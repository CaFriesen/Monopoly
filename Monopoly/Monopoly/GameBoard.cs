...
namespace Monopoly
{
    ...
    public class GameBoard
    {
        ...
        private void initMonopolyBoard()
        {
            ...
            squares.Add(new Street(1, 60, 2, 50, "Old kent road", 100, 50, 0));
            squares.Add(new DrawCard(2, "Draw card", 0, 0, 100, cards.AsReadOnly(), random));
            squares.Add(new Street(3, 60, 2, 50, "Whitechapel road", 100, 50, 0));
            squares.Add(new Taxes(4, "Income tax", 100, 0, 0));
            squares.Add(new Railroad(5, 200, 50, "Kings cross station", 100, 100, 100));
            squares.Add(new Street(6, 100, 4, 50, "The angel islington", 160, 250, 240));
            squares.Add(new DrawCard(7, "Draw card", 0, 0, 100, cards.AsReadOnly(), random));
            squares.Add(new Street(8, 100, 4, 50, "Euston road", 160, 250, 240));
            squares.Add(new Street(9, 120, 4, 50, "Pentonvile road", 160, 250, 240));

            squares.Add(new Jail(10, "Jail", 250, 170, 0));
            squares.Add(new Street(11, 140, 8, 50, "Pall mall", 200, 50, 200));
            squares.Add(new Utility(12, 75, 150, "Electric company", 250, 250, 30));
            squares.Add(new Street(13, 140, 8, 50, "Whitehall", 200, 50, 200));
            squares.Add(new Street(14, 160, 8, 50, "Northumrl'd avenue", 200, 50, 200));
            squares.Add(new Railroad(15, 200, 50, "Marylebone station", 100, 100, 100));
            squares.Add(new Street(16, 180, 16, 50, "Bow street", 250, 170, 0));
            squares.Add(new DrawCard(17, "Draw card", 0, 0, 100, cards.AsReadOnly(), random));
            squares.Add(new Street(18, 180, 16, 50, "Marlborough street", 250, 170, 0));
            squares.Add(new Street(19, 200, 16, 50, "Vine street", 250, 170, 0));

            squares.Add(new Parking(20, "Parking", 0, 0, 0));
            squares.Add(new Street(21, 220, 32, 50, "Strand", 255, 0, 0));
            squares.Add(new DrawCard(22, "Draw card", 0, 0, 100, cards.AsReadOnly(), random));
            squares.Add(new Street(23, 220, 32, 50, "Fleet street", 255, 0, 0));
            squares.Add(new Street(24, 240, 32, 50, "Trafalgar square", 255, 0, 0));
            squares.Add(new Railroad(25, 200, 50, "Fenchurch st. Station", 100, 100, 100));
            squares.Add(new Street(26, 260, 64, 50, "Leicester square", 255, 250, 30));
            squares.Add(new Street(27, 260, 64, 50, "Coventry street", 255, 250, 30));
            squares.Add(new Utility(28, 75, 150, "Water works", 250, 250, 30));
            squares.Add(new Street(29, 280, 64, 50, "Piccadilly", 255, 250, 30));

            squares.Add(new GoToJail(30, "Go to jail", 250, 170, 0));
            squares.Add(new Street(31, 300, 128, 50, "Regent street", 0, 150, 40));
            squares.Add(new Street(32, 300, 128, 50, "Oxford street", 0, 150, 40));
            squares.Add(new DrawCard(33, "Draw card", 0, 0, 100, cards.AsReadOnly(), random));
            squares.Add(new Street(34, 300, 128, 50, "Bond street", 0, 150, 40));
            ...
            squares.Add(new Street(37, 350, 256, 50, "Park lane", 0, 100, 150));
            squares.Add(new Taxes(38, "Super Tax", 100, 0, 0));
            squares.Add(new Street(39, 400, 256, 50, "Mayfair", 0, 100, 150));
        }
